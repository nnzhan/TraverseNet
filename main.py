...
def main():
    ...
    parser.add_argument('--graph_path1', type=str, help='preprocessed graph for graph traversenet')
    ...
    parser.add_argument('--num_rel', type=int, help='number of relations')
    ...
    parser.add_argument('--out_level', type=int, default=0, help='out_level, 0 for traffic flow prediction, 2 for traffic speed prediction.')
